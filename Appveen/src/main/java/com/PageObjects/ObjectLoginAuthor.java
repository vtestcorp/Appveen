...
public class ObjectLoginAuthor extends Keyword {
	...
	public By appveenlogo=By.xpath("//div[@class='logo ng-tns-c129-15']");
	...
	public By searchTextBox=By.xpath("//input[@id='searchTerm']");
	...
	///////////// Dropdown Options when we select Text type//////////////
	...
	public By regularExpressionTextbox=By.xpath("//input[@id='_pattern']"); 
