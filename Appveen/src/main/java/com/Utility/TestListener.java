...
public class TestListener extends BaseClass implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		temptest = extent.createTest("Appveen");
		temptest.log(Status.INFO, "Appveen");
		htmlReporter.config().setReportName("Appveen-Demo");
		htmlReporter.config().setDocumentTitle("Datastack");// Title of Report
	...
	public String screenshotforExtentReport(WebDriver driver, String tcName) {
		...
		String screenshotPath = System.getProperty("user.dir") + "/Screenshots/" + tcName + " ExtentReport " + datetime
				+ ".png";
